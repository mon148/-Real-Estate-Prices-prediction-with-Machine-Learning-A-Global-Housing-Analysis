...
**The lists above show that the quality and the ability or capability of this model is not based only on real-estate price alone, but also works for banks, marketers, other companies. Whether it's London, New York, , or Nigeria, Dubai — a good predictor removes guesswork!  
...
**WHAT I DID IN THE DATA CLEANING STAGE WHICH ENABLE DATA REUSABILITY**  
...
A lot more but to mention few. Over 35% of reason for the cleaning is to ensure the model that would be built using the cleaned data learn from reality/authencity not noise  
  
**What I discovered in the exploratory data analysis stage**  
**Property that are furnished has high premium price**  
...
#### Multiple models were tested but Random Forest performed best because it managed complex non-linear patterns and interactions between features
  
**The RMSE (Root Mean Sqaured Error) of the Random Forest gave out 0.4 and r2 as 0.8 unlike the rest of the models that produces more than 0.45 of the RMSE and lest than 0.75 of r2_score which typically assigning in the ML term, the other models apart from RF are yet to the optimism**  
  
**The features that influence the price most are:**  
- **Location**   
- **Bedroom**  
- **Bathrooms**  
- **Area(extracted from title column)**  
- **property type**   
- **furnisshing**   
...
- **Real-estate planners and agents meeting location**
-  **And so on...**  
  
**Global real estate is a gold but without data, we are mining it blindly!!**  
**Using this, this project would guide the user or the company who decide to clone it into how to use Machine Learning model to make smarter, faster and more profitable decisions!!!**
